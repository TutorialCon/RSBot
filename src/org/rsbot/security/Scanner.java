...
public class Scanner {
	...
	public static void Clean() {
		...
		if (removeFiles.size() > 0) {
			...
			SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					JOptionPane.showMessageDialog(WindowUtil.getBotGUI(), new String[]{"RSBot will now close all external java programs to clean files.", "Please save your unsaved work and click OK to proceedd."}, "Security", JOptionPane.ERROR_MESSAGE, null);
					selectedOption = 0;
				}
			});
